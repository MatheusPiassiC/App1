...
const authService = {
	...
	authenticate: async (email, password) => {//verifica se o usuário existe no array para autenticá-lo
...
export function Login() {
	...
	//define a configuração da tela de login
	return (
...
//posso tentar implementar um salvamento local com useStorage
//ao invés de usar o vetor
